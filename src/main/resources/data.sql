insert into categoria (id, nome, descricao) values
   (1, 'FRUTO','Tipos diversos, atacado e varejo'),
   (2, 'MUDAS','Mudas diversas'),
   (3, 'SEMENTES','Atacado e varejo'),
   (4, 'OUTROS', 'Derivados, ingredientes');
...
insert into foto (id, nome, mimetype, data) values
   (1, 'hass.png',               'image/jpeg', FILE_READ('classpath:fotos/hass.png')),
   (2, 'fortuna.png',            'image/jpeg', FILE_READ('classpath:fotos/fortuna.png')),
   (3, 'breda.png',              'image/jpeg', FILE_READ('classpath:fotos/breda.png')),
   (4, 'mudam.png',              'image/jpeg', FILE_READ('classpath:fotos/mudam.png')),
   (5, 'mudap.png',              'image/jpeg', FILE_READ('classpath:fotos/mudap.png')),
   (6, 'semente.png',            'image/jpeg', FILE_READ('classpath:fotos/semente.png')),
   (7, 'azeite.png',             'image/jpeg', FILE_READ('classpath:fotos/azeite.png')),
   (8, 'azeitehass.png',         'image/jpeg', FILE_READ('classpath:fotos/azeitehass.png')),
   (9, 'shampoo.png',            'image/jpeg', FILE_READ('classpath:fotos/shampoo.png'));
